...
<link href="style.css" rel="stylesheet" type="text/css">
   ...
   <script language="javascript">
     <!--
       ...
       function log(){
  		 window.opener.location.href='inputForm.jsp';
  		 window.close(); 
  		}
     -->
   </script>
...
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle" bgcolor="<%=title_c%>" >
      ...
      <input type="button" value="회원가입" onclick="log()">
      
      <!-- <input type="button" value="회원가입" onclick="javascript:window.opener='inputForm.jsp'">-->
