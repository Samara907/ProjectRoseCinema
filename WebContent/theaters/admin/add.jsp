...
<div class="page-header">
	<h1>극장 관리<small>새로운 극장 추가</small></h1>
	<p>새 극장을 등록합니다.</p>
</div>
			...
			<td>
				...
				<table class="table">
					<tr>
						...
						<td colspan="3"><input type="text" id="theater_name" class="form-control"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input type="text" id="adress" class="form-control"></td>
						<td></td>
					</tr>
					<tr>
						<td><label for="phone">전화 번호</label></td>
						<td colspan="3"><input type="text" id="phone" class="form-control"></td>
					</tr>
				</table>
			</td>
		</tr>
